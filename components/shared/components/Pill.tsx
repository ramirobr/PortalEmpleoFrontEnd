...
const Pill: React.FC<PillProps> = ({
  ...
  return (
    <span
      className={`inline-flex w-fit items-center gap-1 px-2 py-1 rounded font-semibold ${variantClasses} ${bgColorClass} ${textColorClass} ${fontSizeClass} ${className}`}
    ...
    >
      ...
      {showRemoveButton && (
        <button
          ...
          className="flex items-center justify-center hover:bg-primary/30 rounded-full transition-colors text-current cursor-pointer p-0.5 shrink-0"
          aria-label="Remover"
        >
