    ...
    <div className="bg-white rounded-xl shadow-sm hover:shadow-2xl transition-all duration-500 p-8 flex flex-col gap-6 relative border border-zinc-50 group hover:-translate-y-1.5">
      <div className="flex items-start gap-5">
        ...
        <div className="flex-1 min-w-0 py-1">
          ...
          {rec.sector && (
            <p className="text-[11px] font-bold text-slate-600 uppercase tracking-[0.2em] italic">
              {rec.sector}
            </p>
          )}
        </div>
      ...
      <div className="flex items-center justify-between pt-6 border-t border-zinc-100">
          ...
          <div>
            {rec.nombreRevisor ? (
              <>
                ...
                {rec.cargoRevisor && (
                  <p className="text-[11px] text-slate-600 font-bold uppercase tracking-widest mt-0.5">
                    {rec.cargoRevisor}
                  </p>
                )}
              </>
        ...
        <span className="text-[11px] text-slate-600 font-bold uppercase tracking-[0.2em] italic" suppressHydrationWarning>
...
export default function RecomendacionesPage() {
  ...
  const { recomendaciones, loading } = dataState;
          ...
          <div className="p-10 mb-12 bg-white rounded-5xl shadow-sm border border-zinc-50 relative overflow-hidden group">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 relative z-10">
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-[11px] text-slate-600 font-bold uppercase tracking-[0.2em] mt-2 italic">
                  Puntuación promedio
                </span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2 lg:ml-auto p-8 rounded-xl bg-primary/2 border border-primary/5 min-w-[200px]">
                ...
                <span className="text-[11px] text-primary font-bold uppercase tracking-[0.2em] italic">
