...
export default function CambiarContrasena() {
  ...
  // Trigger re-validation of confirmNewPassword when newPassword changes to avoid persistent out-of-sync error messages
  useEffect(() => {
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 size-5 text-slate-400 cursor-pointer disabled:cursor-not-allowed"
