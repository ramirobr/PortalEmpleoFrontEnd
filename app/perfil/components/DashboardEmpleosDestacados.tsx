    ...
    <section aria-labelledby="featured-jobs-title">
      ...
      <ul className="flex flex-col gap-4">
        {jobs.length ? (
              ...
              >
                <div className="bg-white rounded-xl border border-zinc-100 shadow-sm group-hover:shadow-md transition-shadow p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div
                      className="flex items-center gap-1 bg-secondary/10 text-secondary rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-wider"
          ...
          <li className="bg-white rounded-xl border border-zinc-100 p-8 text-center text-slate-400 text-sm">
