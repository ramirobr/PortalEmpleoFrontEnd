...
export default function JobCard({ job }: { job: Job }) {
  ...
  return (
    <div className="bg-white border rounded-md p-6 shadow hover:shadow-lg transition mb-3 relative border-gray-light">
      {/* Company Logo */}
        ...
        <div className="w-4/5">
          ...
          <div className="mb-1 flex items-center gap-2">
            ...
            {job.skills && job.skills.length > 0 ? (
              ...
              <span className="text-gray-400">No hay habilidades listadas</span>
            )}
          </div>
          <p className="mb-1">
