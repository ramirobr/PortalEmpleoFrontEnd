...
function CompanyMapField({ form }: { form: UseFormReturn<FormValues> }) {
  return (
...
function CompanyContactFields({
  ...
  onPwdMouseUp: () => void;
  onPwdClick: () => void;
  onRepeatMouseDown: () => void;
  onRepeatMouseUp: () => void;
  onRepeatClick: () => void;
}) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 gap-y-8">
            ...
            <FormControl>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 size-5 text-slate-400 cursor-pointer"
                  onMouseDown={onRepeatMouseDown}
                  onMouseUp={onRepeatMouseUp}
                  onMouseLeave={onRepeatMouseUp}
...
function CompanyAgreements({ form }: { form: UseFormReturn<FormValues> }) {
  return (
    ...
    <Form {...form}>
      ...
      >
        <fieldset className="border-0 p-0">
          ...
          <CompanyInfoFields form={form} fields={fields} />
        </fieldset>
        ...
        <fieldset className="border-0 p-0">
          ...
          <CompanyContactFields
            ...
            onPwdMouseDown={() => setShowPassword(true)}
            onPwdMouseUp={() => setShowPassword(false)}
            onPwdClick={() => handlePasswordToggle("password")}
            onRepeatMouseDown={() => setShowRepeatPassword(true)}
            onRepeatMouseUp={() => setShowRepeatPassword(false)}
            onRepeatClick={() => handlePasswordToggle("repeat")}
          />
        </fieldset>

        <CompanyAgreements form={form} />
...
export default function CompanyForm({ fields }: CompanyFormProps) {
  ...
  return (
    <Card className="w-full max-w-2xl px-6 mt-4">
      ...
      <CompanySignupForm form={form} onSubmit={onSubmit} fields={fields} />
    </Card>
  );
}
