            ...
            {[
              ...
              >
                ...
                <div className="space-y-0.5 min-w-0">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-gray-dark">
                    {item.label}
                  </p>
          ...
          <CardContent className="pt-0 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm min-w-0">
                <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-gray-dark mb-0.5">
                  Dirección
                </p>
          ...
          <CardContent className="pt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center gap-3 p-4 bg-surface-container-low rounded-xl">
                ...
                <div className="text-sm">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-gray-dark mb-1">
                    Estado
                  </p>
                  <Pill
                    variant={
