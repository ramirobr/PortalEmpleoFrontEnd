...
<<<<<<< HEAD
                <Link
                  ...
                  aria-label={`Visualizar perfil de ${aplicante.usuario.nombreCompleto}`}
                >
                ...
                {aplicante.usuario.email ? (
                  <a
                    href={`mailto:${aplicante.usuario.email}`}
                    ...
                    aria-label={`Enviar correo a ${aplicante.usuario.nombreCompleto}`}
                  >
                  ...
                  <button
                    type="button"
                    disabled
                    className="relative flex items-center justify-center gap-3 px-12 py-2.5 bg-slate-300 text-white font-black text-[11px] uppercase tracking-widest rounded-full min-w-[160px] w-full sm:w-auto cursor-not-allowed"
                    aria-label={`Correo no disponible para ${aplicante.usuario.nombreCompleto}`}
                  >
