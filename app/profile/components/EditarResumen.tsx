...
export default function EditarResumen({
  ...
  const handleSubmit = async (data: z.infer<typeof schema>) => {
    const body = {
      ...data,
      idCurriculum: idCurriculum || curriculum?.idCurriculum,
    ...
    const setProfesion = useAuthStore.getState().setProfesion;
    setProfesion(data.resumenProfesional);
    toast.success(res?.data || "Resumen actualizado");
    form.reset(data);
    setIsEditing(false);
  };
