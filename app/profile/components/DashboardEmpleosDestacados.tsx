        ...
        {jobs.length ? (
          jobs.slice(0, 3).map((job) => (
            <li key={job.id}>
              ...
              >
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm group-hover:shadow-md transition-shadow p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    >
                      <Star className="w-3 h-3 fill-secondary" aria-hidden="true" />
                      ...
                      <li key={req} className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <CheckCircle2
                            ...
                            aria-hidden="true"
                          />
                          <span className="text-sm text-gray-600 font-medium">{req}</span>
                        </div>
          ...
          <li className="bg-white rounded-xl border border-gray-100 p-8 text-center text-gray-400 text-sm">
