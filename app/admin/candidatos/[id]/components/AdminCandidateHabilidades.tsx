...
interface AdminCandidateHabilidadesProps {
  habilidades: Habilidades[];
}

function getNivelColor(nivel: string): { bgColor: string; textColor: string } {
...
export default function AdminCandidateHabilidades({
  habilidades,
}: AdminCandidateHabilidadesProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
                  ...
                  >
                    ...
                    {skill.aniosExperiencia > 0 && (
                      <span className="opacity-70 text-[10px]">
                        · {skill.aniosExperiencia} año{skill.aniosExperiencia !== 1 ? "s" : ""}
                      </span>
                    )}
      ...
      <div className="mt-4 pt-4 border-t border-zinc-100">
        <p className="text-xs text-slate-500 mb-2">Nivel de habilidad:</p>
