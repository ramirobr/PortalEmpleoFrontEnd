...
interface CarpetaEmpresaFormDialogProps {
  open: boolean;
...
export default function CarpetaEmpresaFormDialog({
  open,
  onOpenChange,
  carpeta,
  carpetas,
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing
              ...
              : "Crea una nueva carpeta para organizar los archivos."}
          </DialogDescription>
        </DialogHeader>
