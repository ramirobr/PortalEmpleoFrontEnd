      ...
      <div className="rounded-lg lg:shadow shadow-none p-6 flex flex-col gap-6 bg-white">
        ...
        <div className="relative flex items-stretch w-full group h-12">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 rounded-full bg-white text-slate-700 text-xs shadow-md border-2 border-zinc-100 focus:border-primary/20 focus:ring-4 focus:ring-primary/10 transition-all outline-none"
          />
        </div>
        ...
        <div>
          <span className="text-black font-bold block">Provincia</span>
        ...
        <div>
          <span className="text-black font-bold block">Ciudad</span>
          <SearchAutocomplete<string>
            className="w-full mt-1"
            options={[
              { id: " ", label: "Todas" },
        ...
        <div>
          <span className="text-black font-bold block">Nivel de educación</span>
          <Select
        ...
        <div>
          <span className="text-black font-bold block">Preferencia de horario</span>
          <Select
...
export function CandidateFilters(props: Props) {
  return (
    <Suspense fallback={null}>
      <CandidateFiltersInner {...props} />
    </Suspense>
  );
}
