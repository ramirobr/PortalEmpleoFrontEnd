  ...
  return (
    <div className="bg-white shadow-sm hover:shadow-2xl transition-all duration-700 rounded-xl overflow-hidden border border-zinc-50">
      ...
      <div className="p-8">
        {profile.descripcion && (
          <div className="mb-8">
            <h3 className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-3 ml-1">Acerca de la empresa</h3>
            <p className="text-slate-700 leading-relaxed text-base bg-zinc-50/50 p-6 rounded-xl border border-zinc-100/50">
              {profile.descripcion}
            </p>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {[
            ...
            <div key={item.label} className="flex items-center gap-5 p-6 bg-zinc-50/50 rounded-3xl border border-zinc-100 hover:border-primary/20 hover:bg-white hover:shadow-lg transition-all duration-300 group">
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-600">{item.label}</p>
        ...
        {profile.fechaRegistro && (
          <div className="mt-8 pt-6 border-t border-zinc-50 flex items-center gap-2 text-xs text-slate-400 font-medium" suppressHydrationWarning>
