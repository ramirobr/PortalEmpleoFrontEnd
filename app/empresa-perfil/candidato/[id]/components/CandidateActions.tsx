    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mt-4 pt-4 border-t border-zinc-100">
        <div className="flex gap-2">
          <button
            className="flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm text-slate-600 hover:text-primary hover:bg-zinc-50 rounded-lg transition-colors"
