                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div className="min-w-0 flex-1 mr-4">
                        <h3 className="text-lg font-semibold text-slate-900 group-hover:text-primary transition-colors truncate">
                    ...
                    <div className="mt-6 flex gap-2">
                       <PremiumButton 
                        href={`/empresa-perfil/candidato/${aplicante.idUsuario}`}
                        variant="primary" 
                        size="sm" 
                        className="flex-1"
                       >
