import { GetAllJobsResponse, GetJobByIdResponse } from "@/types/jobs";
...
export async function fetchAllJobs(filters: JobFilters = {}) {
  const json = await fetchApi<GetAllJobsResponse>("/Jobs/getAll", {
    method: "POST",
    body: filters,
  });
  return json?.data;
