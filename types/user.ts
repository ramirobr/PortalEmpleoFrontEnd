...
export type ExperienciaLaboralResponse = GenericResponse<ExperienciaLaboralData>
...
export type SignUpFieldsResponse =
  CatalogFieldsFromTypes<typeof SIGN_UP_FIELDS, CatalogsByType[]>;